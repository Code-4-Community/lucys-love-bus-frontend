...
const SignupFormContainer: React.FC<SignupFormContainerProps> = ({
  ...
  return (
    ...
    /**
     * IDEA: create announcements form that takes initial values, reuse component for create and edit, delete is just a regular "delete" page with a confirmation checkbox
     */
  );
};
